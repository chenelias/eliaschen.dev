        ...
        <div className="rounded-2xl border border-black/10 bg-[rgba(249,250,251,0.68)] shadow-[0_6px_18px_rgba(2,6,23,0.08)] backdrop-blur-lg dark:border-white/10 dark:bg-[rgba(17,17,17,0.62)] dark:shadow-[0_6px_18px_rgba(2,6,23,0.28)]">
          <nav className="flex items-center gap-3 px-3 py-2 text-base">
            <Link href="/" className="group">
              <h2 className="notranslate flex items-center gap-1 text-base font-bold tracking-tighter">
                <span className=" !mt-[2px] text-2xl duration-150 group-hover:rotate-[17.5deg]">
                  <FaSlackHash />
                </span>
              </h2>
            </Link>
            <div className="headernav hidden text-sm md:inline-flex">
              {NavLinks.map((links) => (
                <Link
                  key={links.link}
                  ...
                  className={`${
                    links.title === "" ? "hidden" : ""
                  } px-2 underline-offset-8 hover:underline ${
