  ...
  return (
    <main>
      ...
      <div className="xs:ml-0 ml-2">
        <div className="flex flex-col-reverse sm:flex-row items-start my-5 ">
          <div className="flex flex-col pr-8">
            ...
            <h2 className="about-handwrite text-sm md:text-base text-gray-500 dark:text-gray-400 mb-1 mt-[-0.1px]">
        ...
        <div className="mt-[-40px]">
          <h1 className="text-xl font-medium mb-1">Skills</h1>
          <p className="text-sm">
        ...
        <Link href="/about" className="group inline-block mt-5 p-1">
          <div className="items-center flex w-[150px] text-sm whitespace-nowrap">
            <p className="about-handwrite text-base md:text-lg whitespace-nowrap">Learn more about me</p>
      ...
      <div className="mt-[50px]">
        <h1 className="about-handwrite tracking-tighter text-2xl mb-3 font-extrabold">
          Featured Projects
        </h1>
